/**
 * Game 2 screen assets (Figma frame เกม1.2 · 362:982).
 * Export names mirror the files under `public/figma-assets/game2/`.
 */
...
export const imgRepeatSamTiny1 = `${P}/repeat-sam-tiny-1.svg`;
export const imgRepeatSamTiny2 = `${P}/repeat-sam-tiny-2.svg`;
